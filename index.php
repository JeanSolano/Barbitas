                ...
                <div class="col-md-6 ms-sm-auto col-lg-10 p-0">
                    <section class="hero-section d-flex justify-content-center align-items-center" id="">
                            ...
                            <div class="container">
                                <div class="row">
                                    ...
                                    <div class="col-lg-8 col-12">
                                        <h1 class="text-white mb-lg-3 mb-4"><strong>Barberia Barbitas</strong></h1>
                                        <p class="text-black">Consigue los mejores cortes profesionales solamente para ti</p>
                                        <br>
                                        <a class="btn custom-btn custom-border-btn custom-btn-bg-white smoothscroll me-2 mb-2" href="#section_2">Sobre Nosotros</a>

                                        <a class="btn custom-btn smoothscroll mb-2" href="#section_3">Nuestos servicios</a>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="custom-block d-lg-flex flex-column justify-content-center align-items-center">
                                ...
                                <h4><strong class="text-white">¡Atrévete a lucir increíble, el cambio empieza en nuestra barbería!</strong></h4>
                            </div>
                    </section>
                        ...
                        <div class="container">
                            <div class="row">
                                ...
                                <div class="col-lg-12 col-12 mx-auto">
                                    <h2 class="mb-4">Los mejores barberos</h2>

                                    <div class="border-bottom pb-3 mb-5">
                                        <p>Bienvenido a Gentlemen's Barber Shop, donde la tradición y la modernidad se encuentran. Nuestro equipo de expertos barberos está dedicado a ofrecerte cortes de cabello y servicios de cuidado personal de la más alta calidad. Aquí, cada detalle importa, porque sabemos que tu estilo es nuestra mejor carta de presentación.</p>
                                        <a href="nosotros.html" class="btn custom-btn custom-border-btn ms-2">Si quieres saber mas sobre nosotros, haz click aquí</a>
                                    </div>
                                </div>

                                    <h6 class="mb-5">Conoce a nuestros barberos</h6>
                    ...
                    <section class="price-list-section section-padding" id="">
                        <div class="container">
                            <div class="row">
                                ...
                                <div class="col-lg-5 col-12 contact-block-wrap mt-5 mt-lg-0 pt-4 pt-lg-0 mx-auto">
                                    <div class="contact-block">
                                        <h6 class="mb-0">
                                            ...
                                            <strong>Abiertos todos los dias desde</strong>

                                            <span class="ms-auto text-white">10:00 AM - 8:00 PM</span>
                                        </h6>
                                    </div>
                                </div>

                                <div class="col-lg-12 col-12 mx-auto mt-5 pt-5">
                                    <iframe class="google-map" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d15710.18172740441!2d-79.4250532!3d9.0215721!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x8faca8a9f3e7e0e7%3A0x2e1e7b1e5b7c6b2c!2sCosta%20del%20Este%2C%20Panam%C3%A1!5e0!3m2!1ses-419!2spa!4v1717699000000!5m2!1ses-419!2spa" width="100%" height="300" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                                </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-4 col-md-6 col-11">
                                <div class="site-footer-thumb">
                                    <strong class="mb-1">Calle 50</strong>

                                    <p>Calle 50, Ciudad de Panamá, Panamá</p>
                                </div>
                            </div>

                            <div class="col-lg-4 col-md-6 col-11">
                                <div class="site-footer-thumb">
                                    <strong class="mb-1">Costa del Este</strong>

                                    <p>Bulevar Costa del Este, Ciudad de Panamá, Panamá</p>
                                </div>
                            </div>

                            <div class="col-lg-4 col-md-6 col-11">
                                <strong class="mb-1">Albrook</strong>

                                <p>Albrook Mall, Ciudad de Panamá, Panamá</p>
                            </div>
                        </div>
                    </div>

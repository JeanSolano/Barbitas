  ...
  <main class="page-content col-md-8 ms-sm-auto col-lg-9">
    ...
    <footer class="site-footer" id="site-footer">
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-3 col-12">
            ...
            <ul class="footer-menu">
              <li><a href="index.html#servicios">Corte de Cabello</a></li>
              <li><a href="index.html#servicios">Afeitado Clásico</a></li>
              <li><a href="index.html#servicios">Barba y Bigote</a></li>
              <li><a href="cita.html">Reserva tu cita</a></li>
            </ul>
          </div>
          <!-- Columna 4 -->
          <div class="col-lg-3 col-12">
        ...
        <div class="copyright">
          <small class="d-block text-center">&copy; 2025 Gentlemen's Barber Shop. All Rights Reserved.</small>
        </div>
      </div>
    </footer>
